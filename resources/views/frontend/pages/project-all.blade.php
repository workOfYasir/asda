...
<div class="content">
    ...
    <section class="about about_projects-top" data-color-section="white"><div class="about__bg">
    ...
    <section class="all-projects"><div class="all-projects__head" data-color-section="white">
            <div class="wrapper wrapper_large">
                <h2 class="h2 all-projects__h2" data-split-letters>
                    ...
                    <div class="filters all-projects__filters" id="filters">
                        ...
                        <button class="filters__button filters__button_active wow fadeInUp" data-wow-delay="0.2s" data-filter="*">
                            All
                        </button>
                                                    <button class="filters__button wow fadeInUp" data-wow-delay="0.4s" data-filter="[data-filter-card=commercial]">
                                commercial                            </button>
                                                    <button class="filters__button wow fadeInUp" data-wow-delay="0.6s" data-filter="[data-filter-card=architecture]">
                                architecture                            </button>
                                                    <button class="filters__button wow fadeInUp" data-wow-delay="0.8s" data-filter="[data-filter-card=residential]">
                                residential                            </button>
                                            </div>
                    ...
                    <div class="view all-projects__view">
                        ...
                        <button class="view__button view__button_active wow fadeInUp" data-wow-delay="1.2s" data-view="4">
                            4
                        </button>
                    </div>
                </div>
        ...
        <div class="all-projects__body" data-color-section="dark">
            <div class="wrapper wrapper_large">
                ...
                <div class="all-projects__inner" data-isotope>
                                                                                                                                    <a href="https://yodezeen.com/projects/virgin-izakaya-bar-odesa/" class="card card_small all-projects__card" data-filter-card="commercial">
                                    <div class="card__outer">

                                        <img class="card__bg b-lazy" 
                                        data-src="https://yodezeen.com/wp-content/uploads/2022/02/11-1024x682.jpg" 
                                        src='assets/img/cursor-dark.png'/>

                                        <div class="card__content">
                                            <h2 class="h2 card__h2">
                                                Virgin Izakaya Bar Odesa<!--wow fadeInUp-->
                                            </h2>
                                        </div>
                                    </div>
                                </a>
                                                                                                                                                <a href="https://yodezeen.com/projects/bontoni-boutique/" class="card card_small all-projects__card" data-filter-card="commercial">
                                    <div class="card__outer">

                                        <img class="card__bg b-lazy" 
                                        data-src="https://yodezeen.com/wp-content/uploads/2022/02/The-Bontoni-Boutique-by-YODEZEEN_5-1024x768.jpg" 
                                        src='assets/img/cursor-dark.png'/>

                                        <div class="card__content">
                                            <h2 class="h2 card__h2">
                                                Bontoni Boutique<!--wow fadeInUp-->
                                            </h2>
                                        </div>
                                    </div>
                                </a>
                                                                                                                                                <a href="https://yodezeen.com/projects/shelest/" class="card card_small all-projects__card" data-filter-card="architecture">
                                    <div class="card__outer">

                                        <img class="card__bg b-lazy" 
                                        data-src="https://yodezeen.com/wp-content/uploads/2021/09/Avr7_Page_05-1024x682.jpg" 
                                        src='assets/img/cursor-dark.png'/>

                                        <div class="card__content">
                                            <h2 class="h2 card__h2">
                                                Shelest<!--wow fadeInUp-->
                                            </h2>
                                        </div>
                                    </div>
                                </a>
                                                                                                                                                <a href="https://yodezeen.com/projects/45-restaurant/" class="card card_small all-projects__card" data-filter-card="commercial">
                                    <div class="card__outer">

                                        <img class="card__bg b-lazy" 
                                        data-src="https://yodezeen.com/wp-content/uploads/2022/02/Untitled-3-1024x747.jpg" 
                                        src='assets/img/cursor-dark.png'/>

                                        <div class="card__content">
                                            <h2 class="h2 card__h2">
                                                45 Restaurant<!--wow fadeInUp-->
                                            </h2>
                                        </div>
                                    </div>
                                </a>
                                                                                                                                                <a href="https://yodezeen.com/projects/grand-apartment/" class="card card_small all-projects__card" data-filter-card="residential">
                                    <div class="card__outer">

                                        <img class="card__bg b-lazy" 
                                        data-src="https://yodezeen.com/wp-content/uploads/2021/09/Grand-Apartment_by_YODEZEEN_1_Page_23-1024x683.jpg" 
                                        src='assets/img/cursor-dark.png'/>

                                        <div class="card__content">
                                            <h2 class="h2 card__h2">
                                                Grand Apartment<!--wow fadeInUp-->
                                            </h2>
                                        </div>
                                    </div>
                                </a>
                                                                                                                                                <a href="https://yodezeen.com/projects/la-renommee/" class="card card_small all-projects__card" data-filter-card="residential">
                                    <div class="card__outer">

                                        <img class="card__bg b-lazy" 
                                        data-src="https://yodezeen.com/wp-content/uploads/2021/09/La-Renommee_by_YODEZEEN_1_Page_25-1024x767.jpg" 
                                        src='assets/img/cursor-dark.png'/>

                                        <div class="card__content">
                                            <h2 class="h2 card__h2">
                                                La Renommee<!--wow fadeInUp-->
                                            </h2>
                                        </div>
                                    </div>
                                </a>
                                                                                                                                                <a href="https://yodezeen.com/projects/virgin-izakaya-bar/" class="card card_small all-projects__card" data-filter-card="commercial">
                                    <div class="card__outer">

                                        <img class="card__bg b-lazy" 
                                        data-src="https://yodezeen.com/wp-content/uploads/2021/09/Virgin-Izakaya-Bar-by-YODEZEEN-21-1024x682.jpg" 
                                        src='assets/img/cursor-dark.png'/>

                                        <div class="card__content">
                                            <h2 class="h2 card__h2">
                                                Virgin Izakaya Bar<!--wow fadeInUp-->
                                            </h2>
                                        </div>
                                    </div>
                                </a>
                                                                                                                                                <a href="https://yodezeen.com/projects/the-angel-empire/" class="card card_small all-projects__card" data-filter-card="residential">
                                    <div class="card__outer">

                                        <img class="card__bg b-lazy" 
                                        data-src="https://yodezeen.com/wp-content/uploads/2021/04/The-Angel-Empire-by-YODEZEEN_3-1024x767.jpg" 
                                        src='assets/img/cursor-dark.png'/>

                                        <div class="card__content">
                                            <h2 class="h2 card__h2">
                                                The Angel&#8217;s Empire<!--wow fadeInUp-->
                                            </h2>
                                        </div>
                                    </div>
                                </a>
                                                                                                                                                <a href="https://yodezeen.com/projects/the-colossus-apartment/" class="card card_small all-projects__card" data-filter-card="residential">
                                    <div class="card__outer">

                                        <img class="card__bg b-lazy" 
                                        data-src="https://yodezeen.com/wp-content/uploads/2021/04/Colossus-Apartment-by-YODEZEEN-1-1024x682.jpg" 
                                        src='assets/img/cursor-dark.png'/>

                                        <div class="card__content">
                                            <h2 class="h2 card__h2">
                                                The Colossus Apartment<!--wow fadeInUp-->
                                            </h2>
                                        </div>
                                    </div>
                                </a>
                                                                                                                                                <a href="https://yodezeen.com/projects/follower-restaurant-bar/" class="card card_small all-projects__card" data-filter-card="commercial">
                                    <div class="card__outer">

                                        <img class="card__bg b-lazy" 
                                        data-src="https://yodezeen.com/wp-content/uploads/2020/11/FOLLOWER-1_Page_20-1024x682.jpg" 
                                        src='assets/img/cursor-dark.png'/>

                                        <div class="card__content">
                                            <h2 class="h2 card__h2">
                                                Follower Restaurant &#038; Bar<!--wow fadeInUp-->
                                            </h2>
                                        </div>
                                    </div>
                                </a>
                                                                                                                                                <a href="https://yodezeen.com/projects/elegant-apartment/" class="card card_small all-projects__card" data-filter-card="residential">
                                    <div class="card__outer">

                                        <img class="card__bg  b-lazy" 
                                        data-src="https://yodezeen.com/wp-content/uploads/2021/09/Elegant-Apartment_by_YODEZEEN_1_Page_01-1024x682.jpg" 
                                        src='assets/img/cursor-dark.png' />

                                        <div class="card__content">
                                            <h2 class="h2 card__h2">
                                                Elegant Apartment<!--wow fadeInUp-->
                                            </h2>
                                        </div>
                                    </div>
                                </a>
                                                                                                                                                <a href="https://yodezeen.com/projects/par-bar-3/" class="card card_small all-projects__card" data-filter-card="commercial">
                                    <div class="card__outer">

                                        <img class="card__bg  b-lazy" 
                                        data-src="https://yodezeen.com/wp-content/uploads/2020/11/PAR_BAR_1_Page_01-1024x682.jpg" 
                                        src='assets/img/cursor-dark.png' />

                                        <div class="card__content">
                                            <h2 class="h2 card__h2">
                                                Par Bar³<!--wow fadeInUp-->
                                            </h2>
                                        </div>
                                    </div>
                                </a>
                                                                                                                                                <a href="https://yodezeen.com/projects/island-of-north/" class="card card_small all-projects__card" data-filter-card="architecture">
                                    <div class="card__outer">

                                        <img class="card__bg  b-lazy" 
                                        data-src="https://yodezeen.com/wp-content/uploads/2020/11/717_DOM_OSTROV_NEW3_Page_01-1024x584.jpg" 
                                        src='assets/img/cursor-dark.png' />

                                        <div class="card__content">
                                            <h2 class="h2 card__h2">
                                                Island of North<!--wow fadeInUp-->
                                            </h2>
                                        </div>
                                    </div>
                                </a>
                                                                                                                                                <a href="https://yodezeen.com/projects/state-of-art-edition/" class="card card_small all-projects__card" data-filter-card="residential">
                                    <div class="card__outer">

                                        <img class="card__bg  b-lazy" 
                                        data-src="https://yodezeen.com/wp-content/uploads/2020/11/1-3-1024x682.jpg" 
                                        src='assets/img/cursor-dark.png' />

                                        <div class="card__content">
                                            <h2 class="h2 card__h2">
                                                State-of-art Edition<!--wow fadeInUp-->
                                            </h2>
                                        </div>
                                    </div>
                                </a>
                                                                                                                                                <a href="https://yodezeen.com/projects/darling-woods/" class="card card_small all-projects__card" data-filter-card="architecture">
                                    <div class="card__outer">

                                        <img class="card__bg  b-lazy" 
                                        data-src="https://yodezeen.com/wp-content/uploads/2020/11/обложка-1024x732.jpg" 
                                        src='assets/img/cursor-dark.png' />

                                        <div class="card__content">
                                            <h2 class="h2 card__h2">
                                                Darling woods<!--wow fadeInUp-->
                                            </h2>
                                        </div>
                                    </div>
                                </a>
                                                                                                                                                <a href="https://yodezeen.com/projects/our-jade/" class="card card_small all-projects__card" data-filter-card="residential">
                                    <div class="card__outer">

                                        <img class="card__bg  b-lazy" 
                                        data-src="https://yodezeen.com/wp-content/uploads/2020/11/8-1024x683.jpg" 
                                        src='assets/img/cursor-dark.png' />

                                        <div class="card__content">
                                            <h2 class="h2 card__h2">
                                                Our Jade<!--wow fadeInUp-->
                                            </h2>
                                        </div>
                                    </div>
                                </a>
                                                                                                                                                <a href="https://yodezeen.com/projects/triumph/" class="card card_small all-projects__card" data-filter-card="residential">
                                    <div class="card__outer">

                                        <img class="card__bg  b-lazy" 
                                        data-src="https://yodezeen.com/wp-content/uploads/2020/05/16-1024x683.jpg" 
                                        src='assets/img/cursor-dark.png' />

                                        <div class="card__content">
                                            <h2 class="h2 card__h2">
                                                Triumph<!--wow fadeInUp-->
                                            </h2>
                                        </div>
                                    </div>
                                </a>
                                                                                                                                                <a href="https://yodezeen.com/projects/silvan-shore/" class="card card_small all-projects__card" data-filter-card="architecture">
                                    <div class="card__outer">

                                        <img class="card__bg  b-lazy" 
                                        data-src="https://yodezeen.com/wp-content/uploads/2020/11/781_Riviera_Villas_Dom3_Page_03-1024x614.jpg" 
                                        src='assets/img/cursor-dark.png' />

                                        <div class="card__content">
                                            <h2 class="h2 card__h2">
                                                Silvan Shore<!--wow fadeInUp-->
                                            </h2>
                                        </div>
                                    </div>
                                </a>
                                                                                                                                                <a href="https://yodezeen.com/projects/the-house-of-the-narrative-art/" class="card card_small all-projects__card" data-filter-card="residential">
                                    <div class="card__outer">

                                        <img class="card__bg  b-lazy" 
                                        data-src="https://yodezeen.com/wp-content/uploads/2020/04/1_Page_02-1024x682.jpg" 
                                        src='assets/img/cursor-dark.png' />

                                        <div class="card__content">
                                            <h2 class="h2 card__h2">
                                                The House of the narrative art<!--wow fadeInUp-->
                                            </h2>
                                        </div>
                                    </div>
                                </a>
                                                                                                                                                <a href="https://yodezeen.com/projects/golden-dawn/" class="card card_small all-projects__card" data-filter-card="architecture">
                                    <div class="card__outer">

                                        <img class="card__bg  b-lazy" 
                                        data-src="https://yodezeen.com/wp-content/uploads/2020/11/677_GOLDEN_GATE_FASAD5_Page_05-1024x573.jpg" 
                                        src='assets/img/cursor-dark.png' />

                                        <div class="card__content">
                                            <h2 class="h2 card__h2">
                                                Golden Dawn<!--wow fadeInUp-->
                                            </h2>
                                        </div>
                                    </div>
                                </a>
                                                                                                                                                <a href="https://yodezeen.com/projects/culture-estate/" class="card card_small all-projects__card" data-filter-card="residential">
                                    <div class="card__outer">

                                        <img class="card__bg  b-lazy" 
                                        data-src="https://yodezeen.com/wp-content/uploads/2020/04/1_Page_02-4-1024x682.jpg" 
                                        src='assets/img/cursor-dark.png' />

                                        <div class="card__content">
                                            <h2 class="h2 card__h2">
                                                Culture estate<!--wow fadeInUp-->
                                            </h2>
                                        </div>
                                    </div>
                                </a>
                                                                                                                                                <a href="https://yodezeen.com/projects/bolid-house/" class="card card_small all-projects__card" data-filter-card="architecture">
                                    <div class="card__outer">

                                        <img class="card__bg  b-lazy" 
                                        data-src="https://yodezeen.com/wp-content/uploads/2020/11/1_Page_03-1-1024x693.jpg" 
                                        src='assets/img/cursor-dark.png' />

                                        <div class="card__content">
                                            <h2 class="h2 card__h2">
                                                Bolid House<!--wow fadeInUp-->
                                            </h2>
                                        </div>
                                    </div>
                                </a>
                                                                                                                                                <a href="https://yodezeen.com/projects/morn-decaf/" class="card card_small all-projects__card" data-filter-card="residential">
                                    <div class="card__outer">

                                        <img class="card__bg  b-lazy" 
                                        data-src="https://yodezeen.com/wp-content/uploads/2020/11/1_Page_04-1024x683.jpg" 
                                        src='assets/img/cursor-dark.png' />

                                        <div class="card__content">
                                            <h2 class="h2 card__h2">
                                                Morn Decaf<!--wow fadeInUp-->
                                            </h2>
                                        </div>
                                    </div>
                                </a>
                                                                                                                                                <a href="https://yodezeen.com/projects/the-v-fountain/" class="card card_small all-projects__card" data-filter-card="residential">
                                    <div class="card__outer">

                                        <img class="card__bg  b-lazy" 
                                        data-src="https://yodezeen.com/wp-content/uploads/2020/04/FONTAN-1_Page_01-1024x682.jpg" 
                                        src='assets/img/cursor-dark.png' />

                                        <div class="card__content">
                                            <h2 class="h2 card__h2">
                                                The V Fountain<!--wow fadeInUp-->
                                            </h2>
                                        </div>
                                    </div>
                                </a>
                                                                                                                                                <a href="https://yodezeen.com/projects/feeling-the-oat/" class="card card_small all-projects__card" data-filter-card="residential">
                                    <div class="card__outer">

                                        <img class="card__bg  b-lazy" 
                                        data-src="https://yodezeen.com/wp-content/uploads/2020/04/Вариант-на-обложку-3-1024x685.jpg" 
                                        src='assets/img/cursor-dark.png' />

                                        <div class="card__content">
                                            <h2 class="h2 card__h2">
                                                Feeling the oat<!--wow fadeInUp-->
                                            </h2>
                                        </div>
                                    </div>
                                </a>
                                                                                                                                                <a href="https://yodezeen.com/projects/her-apartment/" class="card card_small all-projects__card" data-filter-card="residential">
                                    <div class="card__outer">

                                        <img class="card__bg  b-lazy" 
                                        data-src="https://yodezeen.com/wp-content/uploads/2020/03/MSCW-14-из-54-1024x682.jpg" 
                                        src='assets/img/cursor-dark.png' />

                                        <div class="card__content">
                                            <h2 class="h2 card__h2">
                                                HER Apartment<!--wow fadeInUp-->
                                            </h2>
                                        </div>
                                    </div>
                                </a>
                                                                                                                                                <a href="https://yodezeen.com/projects/angular-house/" class="card card_small all-projects__card" data-filter-card="architecture">
                                    <div class="card__outer">

                                        <img class="card__bg  b-lazy" 
                                        data-src="https://yodezeen.com/wp-content/uploads/2019/09/2019-05-23_CH_001_Page_03-1-1-1024x724.jpg" 
                                        src='assets/img/cursor-dark.png' />

                                        <div class="card__content">
                                            <h2 class="h2 card__h2">
                                                Angular House<!--wow fadeInUp-->
                                            </h2>
                                        </div>
                                    </div>
                                </a>
                                                                                                                                                <a href="https://yodezeen.com/projects/stylish-family-apartment/" class="card card_small all-projects__card" data-filter-card="residential">
                                    <div class="card__outer">

                                        <img class="card__bg  b-lazy" 
                                        data-src="https://yodezeen.com/wp-content/uploads/2019/09/1-1024x683.jpg" 
                                        src='assets/img/cursor-dark.png' />

                                        <div class="card__content">
                                            <h2 class="h2 card__h2">
                                                Stylish family apartment<!--wow fadeInUp-->
                                            </h2>
                                        </div>
                                    </div>
                                </a>
                                                                                                                                                <a href="https://yodezeen.com/projects/enter-a-new-level-of-luxury/" class="card card_small all-projects__card" data-filter-card="residential">
                                    <div class="card__outer">

                                        <img class="card__bg  b-lazy" 
                                        data-src="https://yodezeen.com/wp-content/uploads/2019/05/4-1024x682.jpg" 
                                        src='assets/img/cursor-dark.png' />

                                        <div class="card__content">
                                            <h2 class="h2 card__h2">
                                                Enter a new level of luxury<!--wow fadeInUp-->
                                            </h2>
                                        </div>
                                    </div>
                                </a>
                                                                                                                                                <a href="https://yodezeen.com/projects/house-in-japan/" class="card card_small all-projects__card" data-filter-card="architecture">
                                    <div class="card__outer">

                                        <img class="card__bg  b-lazy" 
                                        data-src="https://yodezeen.com/wp-content/uploads/2019/04/2-1024x768.jpg" 
                                        src='assets/img/cursor-dark.png' />

                                        <div class="card__content">
                                            <h2 class="h2 card__h2">
                                                House in Japan<!--wow fadeInUp-->
                                            </h2>
                                        </div>
                                    </div>
                                </a>
                                                                                                                                                <a href="https://yodezeen.com/projects/private-house-in-italy/" class="card card_small all-projects__card" data-filter-card="architecture">
                                    <div class="card__outer">

                                        <img class="card__bg  b-lazy" 
                                        data-src="https://yodezeen.com/wp-content/uploads/2019/03/10-1024x584.jpg" 
                                        src='assets/img/cursor-dark.png' />

                                        <div class="card__content">
                                            <h2 class="h2 card__h2">
                                                Private house in Italy<!--wow fadeInUp-->
                                            </h2>
                                        </div>
                                    </div>
                                </a>
                                                                                                                                                <a href="https://yodezeen.com/projects/refuture-clinic/" class="card card_small all-projects__card" data-filter-card="commercial">
                                    <div class="card__outer">

                                        <img class="card__bg  b-lazy" 
                                        data-src="https://yodezeen.com/wp-content/uploads/2019/02/1-1024x685.jpg" 
                                        src='assets/img/cursor-dark.png' />

                                        <div class="card__content">
                                            <h2 class="h2 card__h2">
                                                ReFuture Clinic<!--wow fadeInUp-->
                                            </h2>
                                        </div>
                                    </div>
                                </a>
                                                                                                                                                <a href="https://yodezeen.com/projects/minimalist-style-family-apartment/" class="card card_small all-projects__card" data-filter-card="residential">
                                    <div class="card__outer">

                                        <img class="card__bg  b-lazy" 
                                        data-src="https://yodezeen.com/wp-content/uploads/2019/01/9-1-1024x684.jpg" 
                                        src='assets/img/cursor-dark.png' />

                                        <div class="card__content">
                                            <h2 class="h2 card__h2">
                                                Minimalist style family apartment<!--wow fadeInUp-->
                                            </h2>
                                        </div>
                                    </div>
                                </a>
                                                                                                                                                <a href="https://yodezeen.com/projects/ocean-ball-apartment/" class="card card_small all-projects__card" data-filter-card="residential">
                                    <div class="card__outer">

                                        <img class="card__bg  b-lazy" 
                                        data-src="https://yodezeen.com/wp-content/uploads/2019/01/3-5-1024x666.jpg" 
                                        src='assets/img/cursor-dark.png' />

                                        <div class="card__content">
                                            <h2 class="h2 card__h2">
                                                Ocean Ball Apartment<!--wow fadeInUp-->
                                            </h2>
                                        </div>
                                    </div>
                                </a>
                                                                                                                                                <a href="https://yodezeen.com/projects/artists-residence/" class="card card_small all-projects__card" data-filter-card="residential">
                                    <div class="card__outer">

                                        <img class="card__bg  b-lazy" 
                                        data-src="https://yodezeen.com/wp-content/uploads/2019/01/10-3-1024x682.jpg" 
                                        src='assets/img/cursor-dark.png' />

                                        <div class="card__content">
                                            <h2 class="h2 card__h2">
                                                Artist’s residence<!--wow fadeInUp-->
                                            </h2>
                                        </div>
                                    </div>
                                </a>
                                                                                                                                                <a href="https://yodezeen.com/projects/minimalist-style-home/" class="card card_small all-projects__card" data-filter-card="residential">
                                    <div class="card__outer">

                                        <img class="card__bg  b-lazy" 
                                        data-src="https://yodezeen.com/wp-content/uploads/2018/12/0.Обложка-1024x683.jpg" 
                                        src='assets/img/cursor-dark.png' />

                                        <div class="card__content">
                                            <h2 class="h2 card__h2">
                                                Minimalist style home<!--wow fadeInUp-->
                                            </h2>
                                        </div>
                                    </div>
                                </a>
                                                                                                                                                <a href="https://yodezeen.com/projects/catch-seafood-restaurant/" class="card card_small all-projects__card" data-filter-card="commercial">
                                    <div class="card__outer">

                                        <img class="card__bg  b-lazy" 
                                        data-src="https://yodezeen.com/wp-content/uploads/2020/03/1-1024x682.jpg" 
                                        src='assets/img/cursor-dark.png' />

                                        <div class="card__content">
                                            <h2 class="h2 card__h2">
                                                Catch seafood restaurant<!--wow fadeInUp-->
                                            </h2>
                                        </div>
                                    </div>
                                </a>
                                                                                                                                                <a href="https://yodezeen.com/projects/eyewear-store-interior/" class="card card_small all-projects__card" data-filter-card="commercial">
                                    <div class="card__outer">

                                        <img class="card__bg  b-lazy" 
                                        data-src="https://yodezeen.com/wp-content/uploads/2018/10/SPEX-13-1024x683.jpg" 
                                        src='assets/img/cursor-dark.png' />

                                        <div class="card__content">
                                            <h2 class="h2 card__h2">
                                                SPEX eyewear store interior<!--wow fadeInUp-->
                                            </h2>
                                        </div>
                                    </div>
                                </a>
                                                                                                                                                <a href="https://yodezeen.com/projects/perfect-proportions/" class="card card_small all-projects__card" data-filter-card="residential">
                                    <div class="card__outer">

                                        <img class="card__bg  b-lazy" 
                                        data-src="https://yodezeen.com/wp-content/uploads/2018/12/9-1024x686.jpg" 
                                        src='assets/img/cursor-dark.png' />

                                        <div class="card__content">
                                            <h2 class="h2 card__h2">
                                                Perfect proportions<!--wow fadeInUp-->
                                            </h2>
                                        </div>
                                    </div>
                                </a>
                                                                                                                                                <a href="https://yodezeen.com/projects/modern-apartment-with-original-features/" class="card card_small all-projects__card" data-filter-card="residential">
                                    <div class="card__outer">

                                        <img class="card__bg  b-lazy" 
                                        data-src="https://yodezeen.com/wp-content/uploads/2018/10/LIPKI_30_FLOOR-43-1024x684.jpg" 
                                        src='assets/img/cursor-dark.png' />

                                        <div class="card__content">
                                            <h2 class="h2 card__h2">
                                                Modern apartment with original features<!--wow fadeInUp-->
                                            </h2>
                                        </div>
                                    </div>
                                </a>
                                                                                                                                                <a href="https://yodezeen.com/projects/iq-office-interior/" class="card card_small all-projects__card" data-filter-card="commercial">
                                    <div class="card__outer">

                                        <img class="card__bg  b-lazy" 
                                        data-src="https://yodezeen.com/wp-content/uploads/2019/01/2-6-1024x682.jpg" 
                                        src='assets/img/cursor-dark.png' />

                                        <div class="card__content">
                                            <h2 class="h2 card__h2">
                                                IQ office interior<!--wow fadeInUp-->
                                            </h2>
                                        </div>
                                    </div>
                                </a>
                                                                                                                                                <a href="https://yodezeen.com/projects/masculine-interior-for-a-young-bachelor/" class="card card_small all-projects__card" data-filter-card="residential">
                                    <div class="card__outer">

                                        <img class="card__bg  b-lazy" 
                                        data-src="https://yodezeen.com/wp-content/uploads/2018/07/4-30-1024x682.jpg" 
                                        src='assets/img/cursor-dark.png' />

                                        <div class="card__content">
                                            <h2 class="h2 card__h2">
                                                Masculine interior for a young bachelor<!--wow fadeInUp-->
                                            </h2>
                                        </div>
                                    </div>
                                </a>
                                                                                                                                                <a href="https://yodezeen.com/projects/restaurant-interior-italian-editorial-2/" class="card card_small all-projects__card" data-filter-card="commercial">
                                    <div class="card__outer">

                                        <img class="card__bg  b-lazy" 
                                        data-src="https://yodezeen.com/wp-content/uploads/2019/01/2-3-1024x683.jpg" 
                                        src='assets/img/cursor-dark.png' />

                                        <div class="card__content">
                                            <h2 class="h2 card__h2">
                                                Restaurant interior: Italian Editorial #2<!--wow fadeInUp-->
                                            </h2>
                                        </div>
                                    </div>
                                </a>
                                                                                                                                                <a href="https://yodezeen.com/projects/art-family-residence/" class="card card_small all-projects__card" data-filter-card="residential">
                                    <div class="card__outer">

                                        <img class="card__bg  b-lazy" 
                                        data-src="https://yodezeen.com/wp-content/uploads/2018/07/Титулка-35-1024x732.jpg" 
                                        src='assets/img/cursor-dark.png' />

                                        <div class="card__content">
                                            <h2 class="h2 card__h2">
                                                Art family residence<!--wow fadeInUp-->
                                            </h2>
                                        </div>
                                    </div>
                                </a>
                                                                                                                                                <a href="https://yodezeen.com/projects/residence-by-the-lighthouse/" class="card card_small all-projects__card" data-filter-card="architecture">
                                    <div class="card__outer">

                                        <img class="card__bg  b-lazy" 
                                        data-src="https://yodezeen.com/wp-content/uploads/2018/06/обложка-4-1024x732.jpg" 
                                        src='assets/img/cursor-dark.png' />

                                        <div class="card__content">
                                            <h2 class="h2 card__h2">
                                                Residence by the lighthouse<!--wow fadeInUp-->
                                            </h2>
                                        </div>
                                    </div>
                                </a>
                                                                                                                                                <a href="https://yodezeen.com/projects/family-apartment-on-patriarch-ponds/" class="card card_small all-projects__card" data-filter-card="residential">
                                    <div class="card__outer">

                                        <img class="card__bg  b-lazy" 
                                        data-src="https://yodezeen.com/wp-content/uploads/2018/07/2-3-1024x682.jpg" 
                                        src='assets/img/cursor-dark.png' />

                                        <div class="card__content">
                                            <h2 class="h2 card__h2">
                                                Family apartment on Patriarch Ponds<!--wow fadeInUp-->
                                            </h2>
                                        </div>
                                    </div>
                                </a>
                                                                                                                                                <a href="https://yodezeen.com/projects/prairie-house/" class="card card_small all-projects__card" data-filter-card="architecture">
                                    <div class="card__outer">

                                        <img class="card__bg  b-lazy" 
                                        data-src="https://yodezeen.com/wp-content/uploads/2018/06/обложка-1-1024x732.jpg" 
                                        src='assets/img/cursor-dark.png' />

                                        <div class="card__content">
                                            <h2 class="h2 card__h2">
                                                Prairie house<!--wow fadeInUp-->
                                            </h2>
                                        </div>
                                    </div>
                                </a>
                                                                                                                                                <a href="https://yodezeen.com/projects/art-filled-apartment/" class="card card_small all-projects__card" data-filter-card="residential">
                                    <div class="card__outer">

                                        <img class="card__bg  b-lazy" 
                                        data-src="https://yodezeen.com/wp-content/uploads/2018/07/Титулка-1-1024x732.jpg" 
                                        src='assets/img/cursor-dark.png' />

                                        <div class="card__content">
                                            <h2 class="h2 card__h2">
                                                Art-filled apartment<!--wow fadeInUp-->
                                            </h2>
                                        </div>
                                    </div>
                                </a>
                                                                                                                                                <a href="https://yodezeen.com/projects/traditional-style-apartment-in-georgia/" class="card card_small all-projects__card" data-filter-card="residential">
                                    <div class="card__outer">

                                        <img class="card__bg  b-lazy" 
                                        data-src="https://yodezeen.com/wp-content/uploads/2018/07/Титулка-2-1024x732.jpg" 
                                        src='assets/img/cursor-dark.png' />

                                        <div class="card__content">
                                            <h2 class="h2 card__h2">
                                                Traditional style apartment in Georgia<!--wow fadeInUp-->
                                            </h2>
                                        </div>
                                    </div>
                                </a>
                                                                                                                                                <a href="https://yodezeen.com/projects/the-silent-house/" class="card card_small all-projects__card" data-filter-card="architecture">
                                    <div class="card__outer">

                                        <img class="card__bg  b-lazy" 
                                        data-src="https://yodezeen.com/wp-content/uploads/2018/06/обложка-5-1024x732.jpg" 
                                        src='assets/img/cursor-dark.png' />

                                        <div class="card__content">
                                            <h2 class="h2 card__h2">
                                                The Silent House<!--wow fadeInUp-->
                                            </h2>
                                        </div>
                                    </div>
                                </a>
                                                                                                                                                <a href="https://yodezeen.com/projects/above-the-clouds/" class="card card_small all-projects__card" data-filter-card="residential">
                                    <div class="card__outer">

                                        <img class="card__bg  b-lazy" 
                                        data-src="https://yodezeen.com/wp-content/uploads/2018/07/KO5A0768-1024x682.jpg" 
                                        src='assets/img/cursor-dark.png' />

                                        <div class="card__content">
                                            <h2 class="h2 card__h2">
                                                Above the clouds<!--wow fadeInUp-->
                                            </h2>
                                        </div>
                                    </div>
                                </a>
                                                                                                                                                <a href="https://yodezeen.com/projects/rich-textures-and-deep-colors/" class="card card_small all-projects__card" data-filter-card="residential">
                                    <div class="card__outer">

                                        <img class="card__bg  b-lazy" 
                                        data-src="https://yodezeen.com/wp-content/uploads/2018/08/Титулка-4-1-1024x732.jpg" 
                                        src='assets/img/cursor-dark.png' />

                                        <div class="card__content">
                                            <h2 class="h2 card__h2">
                                                Rich textures and deep colors<!--wow fadeInUp-->
                                            </h2>
                                        </div>
                                    </div>
                                </a>
                                                                                                                                                <a href="https://yodezeen.com/projects/vinzer/" class="card card_small all-projects__card" data-filter-card="commercial">
                                    <div class="card__outer">

                                        <img class="card__bg  b-lazy" 
                                        data-src="https://yodezeen.com/wp-content/uploads/2018/07/Титулка-12-1024x732.jpg" 
                                        src='assets/img/cursor-dark.png' />
                                        ...
                                        <div class="card__content">
                                            <h2 class="h2 card__h2">
                                                Vinzer<!--wow fadeInUp-->
                                                                                                                                                ...
                                                                                                                                                <a href="https://yodezeen.com/projects/dream-house/" class="card card_small all-projects__card" data-filter-card="architecture">
                                    <div class="card__outer">

                                        <img class="card__bg  b-lazy" 
                                        data-src="https://yodezeen.com/wp-content/uploads/2018/06/обложка-10-1024x732.jpg" 
                                        src='assets/img/cursor-dark.png' />

                                        <div class="card__content">
                                            <h2 class="h2 card__h2">
                                                Dream House<!--wow fadeInUp-->
                                            </h2>
                                        </div>
                                    </div>
                                </a>
                                                                                                                                                <a href="https://yodezeen.com/projects/copper-interior/" class="card card_small all-projects__card" data-filter-card="residential">
                                    <div class="card__outer">

                                        <img class="card__bg  b-lazy" 
                                        data-src="https://yodezeen.com/wp-content/uploads/2018/07/Титулка-1024x732.jpg" 
                                        src='assets/img/cursor-dark.png' />

                                        <div class="card__content">
                                            <h2 class="h2 card__h2">
                                                Copper Interior<!--wow fadeInUp-->
                                            </h2>
                                        </div>
                                    </div>
                                </a>
                                                                                                                                                <a href="https://yodezeen.com/projects/diamond-apartment/" class="card card_small all-projects__card" data-filter-card="residential">
                                    <div class="card__outer">

                                        <img class="card__bg  b-lazy" 
                                        data-src="https://yodezeen.com/wp-content/uploads/2018/07/Титулка-13-1024x732.jpg" 
                                        src='assets/img/cursor-dark.png' />

                                        <div class="card__content">
                                            <h2 class="h2 card__h2">
                                                Diamond Apartment<!--wow fadeInUp-->
                                            </h2>
                                        </div>
                                    </div>
                                </a>
                                                                                                                                                <a href="https://yodezeen.com/projects/casa-nori-a-cicchetteria/" class="card card_small all-projects__card" data-filter-card="commercial">
                                    <div class="card__outer">

                                        <img class="card__bg  b-lazy" 
                                        data-src="https://yodezeen.com/wp-content/uploads/2020/03/01_3-1024x683.jpg" 
                                        src='assets/img/cursor-dark.png' />

                                        <div class="card__content">
                                            <h2 class="h2 card__h2">
                                                Casa Nori: &#8211; a Cicchetteria<!--wow fadeInUp-->
                                            </h2>
                                        </div>
                                    </div>
                                </a>
                                                                                                                                                <a href="https://yodezeen.com/projects/fort-house/" class="card card_small all-projects__card" data-filter-card="residential">
                                    <div class="card__outer">

                                        <img class="card__bg  b-lazy" 
                                        data-src="https://yodezeen.com/wp-content/uploads/2018/07/Титулка-38-1024x732.jpg" 
                                        src='assets/img/cursor-dark.png' />

                                        <div class="card__content">
                                            <h2 class="h2 card__h2">
                                                Fort House<!--wow fadeInUp-->
                                            </h2>
                                        </div>
                                    </div>
                                </a>
                                                                                                                                                <a href="https://yodezeen.com/projects/forest-house/" class="card card_small all-projects__card" data-filter-card="architecture">
                                    <div class="card__outer">

                                        <img class="card__bg  b-lazy" 
                                        data-src="https://yodezeen.com/wp-content/uploads/2018/06/обложкаpsd-1024x732.jpg" 
                                        src='assets/img/cursor-dark.png' />

                                        <div class="card__content">
                                            <h2 class="h2 card__h2">
                                                Forest house<!--wow fadeInUp-->
                                            </h2>
                                        </div>
                                    </div>
                                </a>
                                                                                                                                                <a href="https://yodezeen.com/projects/hillside-house/" class="card card_small all-projects__card" data-filter-card="architecture">
                                    <div class="card__outer">

                                        <img class="card__bg  b-lazy" 
                                        data-src="https://yodezeen.com/wp-content/uploads/2018/06/обложка-3-1024x732.jpg" 
                                        src='assets/img/cursor-dark.png' />

                                        <div class="card__content">
                                            <h2 class="h2 card__h2">
                                                Hillside house<!--wow fadeInUp-->
                                            </h2>
                                        </div>
                                    </div>
                                </a>
                                                                                                                                                <a href="https://yodezeen.com/projects/without-borders/" class="card card_small all-projects__card" data-filter-card="residential">
                                    <div class="card__outer">

                                        <img class="card__bg  b-lazy" 
                                        data-src="https://yodezeen.com/wp-content/uploads/2018/07/Титулка-37-1-1024x732.jpg" 
                                        src='assets/img/cursor-dark.png' />

                                        <div class="card__content">
                                            <h2 class="h2 card__h2">
                                                Without borders<!--wow fadeInUp-->
                                            </h2>
                                        </div>
                                    </div>
                                </a>
                                                                                                                                                <a href="https://yodezeen.com/projects/indian-creek-island-home/" class="card card_small all-projects__card" data-filter-card="residential">
                                    <div class="card__outer">

                                        <img class="card__bg  b-lazy" 
                                        data-src="https://yodezeen.com/wp-content/uploads/2018/07/Титулка-16-1024x732.jpg" 
                                        src='assets/img/cursor-dark.png' />

                                        <div class="card__content">
                                            <h2 class="h2 card__h2">
                                                Indian Creek Island home<!--wow fadeInUp-->
                                            </h2>
                                        </div>
                                    </div>
                                </a>
...
<section class="footer"><div class="wrapper wrapper_large">
        <div class="footer__inner" style="height: auto; padding-bottom: 38px;">
            <div class="footer__copyright wow fadeInUp" data-wow-delay>
              <div>
                    <a href="https://yodezeen.com/wp-content/uploads/2019/02/Privacy_Notice_Yodezeen.pdf" target="_blank" style="display: inline-block;vertical-align: top; margin-right: 20px;font-size: 10px;line-height: 16px;font-weight: 300;color: #888;text-transform: none;max-width: 500px;margin-top: 10px;">Privacy Notice</a>
                    <a href="https://yodezeen.com/wp-content/uploads/2019/02/Terms_of_Use_Yodezeen.pdf" target="_blank" style="display: inline-block;vertical-align: top; margin-right: 20px;font-size: 10px;line-height: 16px;font-weight: 300;color: #888;text-transform: none;max-width: 500px;margin-top: 10px;">Terms of use</a>
              </div>
