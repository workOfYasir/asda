...
<div class="content">
    <section class="hero hero_top" data-color-section="dark">
        <div class="hero__bg" data-bg-src="https://yodezeen.com/wp-content/uploads/2021/09/Avr7_Page_05.jpg"
            data-bg-size="cover" data-bg-pos="center" data-hero-bg></div>
    ...
    <section class="project pt-5 pb-5" data-color-section="dark">
        <div class="wrapper wrapper_large">
            <div class="project__inner">
               
                <div class="project__row">     
                       @foreach($projects[0]->images as $key => $img)
                       <div class="card card_type-3 project__card">
                        <img class=' card__img b-lazy wow fadeInUp'
                        data-src='{{ asset($img->image) }}' alt="">
                    </div> 
                       @endforeach
    ...
    {{-- <section class="project-links" data-color-section="dark">
        <div class="wrapper wrapper_large">
            <div class="project-links__inner">
                <a href="https://yodezeen.com/projects/bontoni-boutique/ ?all "
                    class="link link_prev project-links__link wow fadeInUp">
                    <div class="link__line"></div>
                    <span class="link__text">
                        Previous project
                    </span>
                </a>
                <a href="https://yodezeen.com/projects/45-restaurant/ ?all "
                    class="link link_next project-links__link wow fadeInUp" data-wow-delay="0.5s">
                    <span class="link__text">
                        Next project
                    </span>
                    <div class="link__line"></div>
...
<section class="footer  footer_dark">
    <div class="wrapper wrapper_large">
