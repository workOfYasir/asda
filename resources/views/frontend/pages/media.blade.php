...
@section('content')
    <div class="content">
        <section class="media"><div class="media__head" data-color-section="white">
                <div class="wrapper wrapper_large">
                    <h2 class="h2 media__h2" data-split-letters>
                        Media                    </h2>
                    <div class="media__inner">
                        <div class="filters media__filters" id="filters">
                        <button class="filters__button filters__button_active wow fadeInUp" data-wow-delay="0.2s" data-filter="*">
                            All
                        </button>
                                                    <button class="filters__button wow fadeInUp" data-wow-delay="0.4s" data-filter="[data-filter-card=online]">
                                online                            </button>
                                                    <button class="filters__button wow fadeInUp" data-wow-delay="0.6s" data-filter="[data-filter-card=magazines]">
                                magazines                            </button>
                                                    <button class="filters__button wow fadeInUp" data-wow-delay="0.8s" data-filter="[data-filter-card=books]">
                                books                            </button>
                                                </div>
                    </div>
                </div>
            ...
            <div class="media__body" data-color-section="white">
                <div class="wrapper wrapper_large">
                    <div class="media__inner" data-isotope data-media-list>
                                                                                                                            <a href="https://www.archdaily.com/891256/fish-restaurant-catch-yodezeen-studio?ad_medium=widget&amp;ad_name=navigation-next" target="_blank" class="card media__card" data-media-card data-filter-card="online">
                                            <!--<button class="card__button" data-media-card-btn></button>-->
                                            <div class="card__wrap">
                                                <img class="card__image" src="../wp-content/uploads/2018/03/archday-1.png">
                                            </div>
                                        </a>
                                                                                                                            <div class="card media__card" data-media-card data-filter-card="online">
                                        <button class="card__button" data-media-card-btn></button>
                                        <div class="card__wrap">
                                            <img class=" card__image" src="../wp-content/uploads/2018/03/dwell.png">
                                        </div>
                                        <div class="journal card__journal" data-journal>
                                            <button class="journal__close" data-journal-close></button>
                                            <div class="journal__list">
                                                                                                    <a href="https://www.dwell.com/article/a-familys-kiev-apartment-is-filled-with-copper-marble-and-a-sophisticated-palette-5f9d5096" target="_blank" class="item journal__item">
                                                        <div class="item__image " src="#" data-bg-size="cover" data-bg-pos="center"></div>
                                                        <div class="item__title">
                                                            A Family's Kiev Apartment Is Filled With Copper, Marble, and a Sophisticated Palette                                                        </div>
                                                    </a>
                                                                                                    <a href="https://www.dwell.com/home/diamond-apartment-485e373a" target="_blank" class="item journal__item">
                                                        <div class="item__image " src="#" data-bg-size="cover" data-bg-pos="center"></div>
                                                        <div class="item__title">
                                                            Diamond apartment                                                        </div>
                                                    </a>
                                                                                            </div>
                                        </div>
                                    </div>
                                                                                                                                <a href="https://www.attitude-mag.com/EN/blog/all/2019-05-14-meet-the-architects-yodezeen/" target="_blank" class="card media__card" data-media-card data-filter-card="online">
                                            <!--<button class="card__button" data-media-card-btn></button>-->
                                            <div class="card__wrap">
                                                <img class="card__image" src="../wp-content/uploads/2019/09/2-1.png">
                                            </div>
                                        </a>
                                                                                                                                <a href="https://www.interiordesign.net/projects/16328-yodezeen-opts-for-sleek-aesthetics-in-kiev-refuture-clinic/" target="_blank" class="card media__card" data-media-card data-filter-card="online">
                                            <!--<button class="card__button" data-media-card-btn></button>-->
                                            <div class="card__wrap">
                                                <img class="card__image" src="../wp-content/uploads/2019/09/1-1.png">
                                            </div>
                                        </a>
                                                                                                                                <a href="https://www.elledecor.com/it/case/a25636349/casa-famiglia-kiev-art-family-residence-yodezeen-architects/" target="_blank" class="card media__card" data-media-card data-filter-card="online">
                                            <!--<button class="card__button" data-media-card-btn></button>-->
                                            <div class="card__wrap">
                                                <img class="card__image" src="../wp-content/uploads/2019/09/2-2.png">
                                            </div>
                                        </a>
                                                                                                                                <a href="https://www.elledecoration.ru/interior/offices-boutiques/sovremennaya-klinika-refuture-clinic-v-kieve-id6821662/" target="_blank" class="card media__card" data-media-card data-filter-card="online">
                                            <!--<button class="card__button" data-media-card-btn></button>-->
                                            <div class="card__wrap">
                                                <img class="card__image" src="../wp-content/uploads/2019/09/3-1.png">
                                            </div>
                                        </a>
                                                                                                                                <a href="https://www.interior.ru/design/place/5446-proekt-yodezeen-lakonichnyj-loft-v-kieve.html" target="_blank" class="card media__card" data-media-card data-filter-card="online">
                                            <!--<button class="card__button" data-media-card-btn></button>-->
                                            <div class="card__wrap">
                                                <img class="card__image" src="../wp-content/uploads/2019/09/4-1.png">
                                            </div>
                                        </a>
                                                                                                                                <a href="https://officesnapshots.com/2018/09/25/vinzer-cookware-offices-kiev/" target="_blank" class="card media__card" data-media-card data-filter-card="online">
                                            <!--<button class="card__button" data-media-card-btn></button>-->
                                            <div class="card__wrap">
                                                <img class="card__image" src="../wp-content/uploads/2019/09/5-1.png">
                                            </div>
                                        </a>
                                                                                                                                <a href="https://officiel-online.com/news?id=8350" target="_blank" class="card media__card" data-media-card data-filter-card="online">
                                            <!--<button class="card__button" data-media-card-btn></button>-->
                                            <div class="card__wrap">
                                                <img class="card__image" src="../wp-content/uploads/2018/03/loffi.png">
                                            </div>
                                        </a>
                                                                                                                                <a href="http://www.contemporist.com/soft-copper-accents-are-scattered-all-over-this-apartment/" target="_blank" class="card media__card" data-media-card data-filter-card="online">
                                            <!--<button class="card__button" data-media-card-btn></button>-->
                                            <div class="card__wrap">
                                                <img class="card__image" src="../wp-content/uploads/2018/03/contemporist-1.png">
                                            </div>
                                        </a>
                                                                                                                                <a href="http://www.thepluspaper.com/2015/07/06/the-vintage-bakery/" target="_blank" class="card media__card" data-media-card data-filter-card="online">
                                            <!--<button class="card__button" data-media-card-btn></button>-->
                                            <div class="card__wrap">
                                                <img class="card__image" src="../wp-content/uploads/2018/03/the-plus.png">
                                            </div>
                                        </a>
                                                                                                                            <div class="card media__card" data-media-card data-filter-card="online">
                                        <button class="card__button" data-media-card-btn></button>
                                        <div class="card__wrap">
                                            <img class=" card__image" src="../wp-content/uploads/2018/03/caandesign-1.png">
                                        </div>
                                        <div class="journal card__journal" data-journal>
                                            <button class="journal__close" data-journal-close></button>
                                            <div class="journal__list">
                                                                                                    <a href="https://www.caandesign.com/apartment-mix-modern-architecture-touch-tradition-vizualized-yodezeen/" target="_blank" class="item journal__item">
                                                        <div class="item__image " src="#" data-bg-size="cover" data-bg-pos="center"></div>
                                                        <div class="item__title">
                                                            Apartment with a mix of modern architecture and touch of tradition vizualized by Yodezeen                                                        </div>
                                                    </a>
                                                                                                    <a href="https://www.caandesign.com/casa-nori-stylish-restaurant-kiev-ukraine-designed-yodezeen/" target="_blank" class="item journal__item">
                                                        <div class="item__image " src="#" data-bg-size="cover" data-bg-pos="center"></div>
                                                        <div class="item__title">
                                                            Casa Nori stylish restaurant in Kiev, Ukraine designed by Yodezeen                                                        </div>
                                                    </a>
                                                                                                    <a href="https://www.caandesign.com/charismatic-darken-apartment-kiev-designed-yodezeen/" target="_blank" class="item journal__item">
                                                        <div class="item__image " src="#" data-bg-size="cover" data-bg-pos="center"></div>
                                                        <div class="item__title">
                                                            Charismatic darken apartment in Kiev designed by YoDezeen                                                        </div>
                                                    </a>
                                                                                                    <a href="https://www.caandesign.com/dark-theme-apartment-designed-yodezeen-kiev/" target="_blank" class="item journal__item">
                                                        <div class="item__image " src="#" data-bg-size="cover" data-bg-pos="center"></div>
                                                        <div class="item__title">
                                                            Dark theme apartment designed by YoDezeen in Kiev                                                        </div>
                                                    </a>
                                                                                                    <a href="https://www.caandesign.com/loft-apartment-in-brooklyn-by-yodezeen/" target="_blank" class="item journal__item">
                                                        <div class="item__image " src="#" data-bg-size="cover" data-bg-pos="center"></div>
                                                        <div class="item__title">
                                                            Loft Apartment in Brooklyn by YoDezeen                                                        </div>
                                                    </a>
                                                                                                    <a href="https://www.caandesign.com/modern-residence-hang-tbilisi-georgia-yodezeen/" target="_blank" class="item journal__item">
                                                        <div class="item__image " src="#" data-bg-size="cover" data-bg-pos="center"></div>
                                                        <div class="item__title">
                                                            Modern Residence to Hang out in Tbilisi, Georgia by Yodezeen                                                        </div>
                                                    </a>
                                                                                                    <a href="https://www.caandesign.com/modern-twilight-apartment-interior-kiev-designed-yodezeen/" target="_blank" class="item journal__item">
                                                        <div class="item__image " src="#" data-bg-size="cover" data-bg-pos="center"></div>
                                                        <div class="item__title">
                                                            Modern Twilight Apartment Interior in Kiev designed by Yodezeen                                                        </div>
                                                    </a>
                                                                                                    <a href="https://www.caandesign.com/stylish-modern-apartment-in-kiev-by-yodezeen/" target="_blank" class="item journal__item">
                                                        <div class="item__image " src="#" data-bg-size="cover" data-bg-pos="center"></div>
                                                        <div class="item__title">
                                                            Stylish Modern Apartment in Kiev by YoDezeen                                                        </div>
                                                    </a>
                                                                                                    <a href="https://www.caandesign.com/tolstyitonkiy-restaurant-game-lights-shadows-kiev/" target="_blank" class="item journal__item">
                                                        <div class="item__image " src="#" data-bg-size="cover" data-bg-pos="center"></div>
                                                        <div class="item__title">
                                                            TOLSTYI&TONKIY restaurant, a game of lights and shadows in Kiev                                                        </div>
                                                    </a>
                                                                                            </div>
                                        </div>
                                    </div>
                                                                                                                                <a href="https://www.cosmorelax.ru/our-projects/blagorodnaya-kvartira-v-kieve-ot-/" target="_blank" class="card media__card" data-media-card data-filter-card="online">
                                            <!--<button class="card__button" data-media-card-btn></button>-->
                                            <div class="card__wrap">
                                                <img class="card__image" src="../wp-content/uploads/2018/03/%d0%ba%d0%be%d1%81%d0%bc%d0%be%d1%80%d0%b5%d0%bb%d0%b0%d0%ba%d1%81-1.html">
                                            </div>
                                        </a>
                                                                                                                                <a href="https://www.designwanted.today/architecture/luxury-apartment-yodezeen/" target="_blank" class="card media__card" data-media-card data-filter-card="online">
                                            <!--<button class="card__button" data-media-card-btn></button>-->
                                            <div class="card__wrap">
                                                <img class="card__image" src="../wp-content/uploads/2018/03/designwanted.png">
                                            </div>
                                        </a>
                                                                                                                            <div class="card media__card" data-media-card data-filter-card="online">
                                        <button class="card__button" data-media-card-btn></button>
                                        <div class="card__wrap">
                                            <img class=" card__image" src="../wp-content/uploads/2018/03/his.png">
                                        </div>
                                        <div class="journal card__journal" data-journal>
                                            <button class="journal__close" data-journal-close></button>
                                            <div class="journal__list">
                                                                                                    <a href="https://his.ua/article/interer-goda-2017-o-luchshih-arhitektorah-goda-i-buduschem-nravstvennogo-dizayna-2017-12-12" target="_blank" class="item journal__item">
                                                        <div class="item__image " src="#" data-bg-size="cover" data-bg-pos="center"></div>
                                                        <div class="item__title">
                                                            «Интерьер года» 2017. О лучших архитекторах года и будущем нравственного дизайна                                                        </div>
                                                    </a>
                                                                                                    <a href="https://his.ua/article/pekarnya-1-interer-ot-yodezeen-2015-06-10" target="_blank" class="item journal__item">
                                                        <div class="item__image " src="#" data-bg-size="cover" data-bg-pos="center"></div>
                                                        <div class="item__title">
                                                            «Пекарня № 1». Интерьер от YoDezeen                                                        </div>
                                                    </a>
                                                                                                    <a href="https://his.ua/article/50-metriv-nad-rivnem-okeanu-2016-01-15" target="_blank" class="item journal__item">
                                                        <div class="item__image " src="#" data-bg-size="cover" data-bg-pos="center"></div>
                                                        <div class="item__title">
                                                            50 метрів над рівнем океану                                                        </div>
                                                    </a>
                                                                                                    <a href="https://his.ua/article/vino-e-cucina-oazis-v-tsentre-megapolisa-2015-08-20" target="_blank" class="item journal__item">
                                                        <div class="item__image " src="#" data-bg-size="cover" data-bg-pos="center"></div>
                                                        <div class="item__title">
                                                            Vino e Cucina. Оазис в центре мегаполиса                                                        </div>
                                                    </a>
                                                                                                    <a href="https://his.ua/article/yodezeen-ne-prekraschayte-mechtat-ved-eto-pridaet-sil-dvigatsya-vpered-2016-05-31" target="_blank" class="item journal__item">
                                                        <div class="item__image " src="#" data-bg-size="cover" data-bg-pos="center"></div>
                                                        <div class="item__title">
                                                            YoDezeen: "Не прекращайте мечтать, ведь это придает сил двигаться вперед"                                                        </div>
                                                    </a>
                                                                                                    <a href="https://his.ua/article/vse-pod-kontrolem-2016-12-20" target="_blank" class="item journal__item">
                                                        <div class="item__image " src="#" data-bg-size="cover" data-bg-pos="center"></div>
                                                        <div class="item__title">
                                                            Все под контролем                                                        </div>
                                                    </a>
                                                                                                    <a href="https://his.ua/article/danina-traditsiyam-vid-yodezeen-2016-07-07" target="_blank" class="item journal__item">
                                                        <div class="item__image " src="#" data-bg-size="cover" data-bg-pos="center"></div>
                                                        <div class="item__title">
                                                            Данина традиціям від YØDEZEEN                                                        </div>
                                                    </a>
                                                                                                    <a href="https://his.ua/article/dizayn-restorana-tolstiy-tonkiy-ot-studii-yodezeen-2016-08-31" target="_blank" class="item journal__item">
                                                        <div class="item__image " src="#" data-bg-size="cover" data-bg-pos="center"></div>
                                                        <div class="item__title">
                                                            Дизайн ресторана Tolstiy&Tonkiy от студии YoDezeen                                                        </div>
                                                    </a>
                                                                                                    <a href="https://his.ua/article/interer-restorana-v-mayami-ot-ukrainskih-avtorov-2015-07-20" target="_blank" class="item journal__item">
                                                        <div class="item__image " src="#" data-bg-size="cover" data-bg-pos="center"></div>
                                                        <div class="item__title">
                                                            Интерьер ресторана в Майами от украинских авторов                                                        </div>
                                                    </a>
                                                                                                    <a href="https://his.ua/article/interernaya-diffuziya-stiley-2017-04-19" target="_blank" class="item journal__item">
                                                        <div class="item__image " src="#" data-bg-size="cover" data-bg-pos="center"></div>
                                                        <div class="item__title">
                                                            Интерьерная диффузия стилей                                                        </div>
                                                    </a>
                                                                                                    <a href="https://his.ua/article/klassika-i-sovremennost-dve-epohi-v-interere-kievskih-apartamentov-ot-yodezeen-2017-12-11" target="_blank" class="item journal__item">
                                                        <div class="item__image " src="#" data-bg-size="cover" data-bg-pos="center"></div>
                                                        <div class="item__title">
                                                            Классика и современность. Две эпохи в интерьере киевских апартаментов от YoDezeen                                                        </div>
                                                    </a>
                                                                                                    <a href="https://his.ua/article/kontrast-tsvetov-stiley-vremen-2017-09-14" target="_blank" class="item journal__item">
                                                        <div class="item__image " src="#" data-bg-size="cover" data-bg-pos="center"></div>
                                                        <div class="item__title">
                                                            Контраст цветов, стилей, времен                                                        </div>
                                                    </a>
                                                                                                    <a href="https://his.ua/article/loft-i-ekzoticheskie-rasteniya-2016-12-30" target="_blank" class="item journal__item">
                                                        <div class="item__image " src="#" data-bg-size="cover" data-bg-pos="center"></div>
                                                        <div class="item__title">
                                                            Лофт и экзотические растения                                                        </div>
                                                    </a>
                                                                                                    <a href="https://his.ua/article/rybnyy-restoran-catch-elegantnyy-interer-ot-studii-yodezeen_2018-02-12" target="_blank" class="item journal__item">
                                                        <div class="item__image " src="#" data-bg-size="cover" data-bg-pos="center"></div>
                                                        <div class="item__title">
                                                            Рыбный ресторан CATCH. Элегантный интерьер от студии YoDezeen                                                        </div>
                                                    </a>
                                                                                                    <a href="https://his.ua/article/shourum-the-coat-ot-dizaynerskoy-komandy-yodezeen-2017-11-29" target="_blank" class="item journal__item">
                                                        <div class="item__image " src="#" data-bg-size="cover" data-bg-pos="center"></div>
                                                        <div class="item__title">
                                                            Шоурум The COAT от дизайнерской команды YoDezeen                                                        </div>
                                                    </a>
                                                                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <button class="card__button" data-media-card-btn></button>
                                        <div class="card__wrap">
                                            <img class=" card__image" src="../wp-content/uploads/2018/03/Home-Design-1.png">
                                        </div>
                                        <div class="journal card__journal" data-journal>
                                            <button class="journal__close" data-journal-close></button>
                                            <div class="journal__list">
                                                                                                    <a href="https://www.homedsgn.com/2016/05/20/a-family-estate-in-krakow-poland-designed-by-the-ukrainian-firm-yodezeen/" target="_blank" class="item journal__item">
                                                        <div class="item__image " src="#" data-bg-size="cover" data-bg-pos="center"></div>
                                                        <div class="item__title">
                                                            A Family Estate in Krakow, Poland Designed by the Ukrainian Firm Yodezeen                                                        </div>
                                                    </a>
                                                                                                    <a href="https://www.homedsgn.com/2016/05/09/a-modern-home-interior-in-kiev-ukraine/" target="_blank" class="item journal__item">
                                                        <div class="item__image " src="#" data-bg-size="cover" data-bg-pos="center"></div>
                                                        <div class="item__title">
                                                            A Modern Home Interior in Kiev, Ukraine                                                        </div>
                                                    </a>
                                                                                                    <a href="https://www.homedsgn.com/2015/07/10/apartment-brooklyn-by-yodezeen/" target="_blank" class="item journal__item">
                                                        <div class="item__image " src="#" data-bg-size="cover" data-bg-pos="center"></div>
                                                        <div class="item__title">
                                                            Apartment Brooklyn by YoDezeen                                                        </div>
                                                    </a>
                                                                                                    <a href="https://www.homedsgn.com/2015/07/06/apartment-kiev-by-yodezeen/" target="_blank" class="item journal__item">
                                                        <div class="item__image " src="#" data-bg-size="cover" data-bg-pos="center"></div>
                                                        <div class="item__title">
                                                            Apartment Kiev by YoDezeen                                                        </div>
                                                    </a>
                                                                                                    <a href="https://www.homedsgn.com/2016/05/27/yodezeen-designs-a-modern-residence-in-tbilisi-georgia/" target="_blank" class="item journal__item">
                                                        <div class="item__image " src="#" data-bg-size="cover" data-bg-pos="center"></div>
                                                        <div class="item__title">
                                                            Yodezeen Designs a Modern Residence in Tbilisi, Georgia                                                        </div>
                                                    </a>
                                                                                            </div>
                                        </div>
                                    </div>
                                                                                                                                                            <a href="https://interiorzine.com/2016/07/25/cozy-and-inviting-apartment-in-kiev-by-yodezeen/" target="_blank" class="card media__card" data-media-card data-filter-card="magazines">
                                            <!--<button class="card__button" data-media-card-btn></button>-->
                                            <div class="card__wrap">
                                                <img class="card__image" src="../wp-content/uploads/2018/03/interni.png">
                                            </div>
                                        </a>
                                                                                                                                <a href="http://ydzn-dev.de-v.pw/wp-content/uploads/2018/05/Yo_Dezeen-Pechersky.pdf" target="_blank" class="card media__card" data-media-card data-filter-card="magazines">
                                            <!--<button class="card__button" data-media-card-btn></button>-->
                                            <div class="card__wrap">
                                                <img class="card__image" src="../wp-content/uploads/2018/03/int.png">
                                            </div>
                                        </a>
                                                                                                                                <a href="http://ydzn-dev.de-v.pw/wp-content/uploads/2018/05/YoDezeen_txt.pdf" target="_blank" class="card media__card" data-media-card data-filter-card="magazines">
                                            <!--<button class="card__button" data-media-card-btn></button>-->
                                            <div class="card__wrap">
                                                <img class="card__image" src="../wp-content/uploads/2018/03/%d1%81%d0%b0%d0%bb%d0%be%d0%bd-1.png">
                                            </div>
                                        </a>
                                                                                                                            <div class="card media__card" data-media-card data-filter-card="magazines">
                                        <button class="card__button" data-media-card-btn></button>
                                        <div class="card__wrap">
                                            <img class=" card__image" src="../wp-content/uploads/2018/03/home-1.png">
                                        </div>
                                        <div class="journal card__journal" data-journal>
                                            <button class="journal__close" data-journal-close></button>
                                            <div class="journal__list">
                                                                                                    <a href="http://ydzn-dev.de-v.pw/wp-content/uploads/2018/05/Yodezeen-HOME-and-Style-apartment-in-Georgia.pdf" target="_blank" class="item journal__item">
                                                        <div class="item__image " src="#" data-bg-size="cover" data-bg-pos="center"></div>
                                                        <div class="item__title">
                                                            В гармонии с природой и собой                                                        </div>
                                                    </a>
                                                                                                    <a href="http://ydzn-dev.de-v.pw/wp-content/uploads/2018/05/Yodezeen-HOME-and-Style-apartment-in-Kiev.pdf" target="_blank" class="item journal__item">
                                                        <div class="item__image " src="#" data-bg-size="cover" data-bg-pos="center"></div>
                                                        <div class="item__title">
                                                            Магия пространства                                                        </div>
                                                    </a>
                                                                                            </div>
                                        </div>
                                    </div>
                                                                                                                                <a href="../wp-content/uploads/2019/09/ARCHI-Y%c3%b8Dezeen-1.pdf" target="_blank" class="card media__card" data-media-card data-filter-card="magazines">
                                            <!--<button class="card__button" data-media-card-btn></button>-->
                                            <div class="card__wrap">
                                                <img class="card__image" src="../wp-content/uploads/2019/09/1.png">
                                            </div>
                                        </a>
                                                                                                                            <div class="card media__card" data-media-card data-filter-card="magazines">
                                        <button class="card__button" data-media-card-btn></button>
                                        <div class="card__wrap">
                                            <img class=" card__image" src="../wp-content/uploads/2019/09/2.png">
                                        </div>
                                        <div class="journal card__journal" data-journal>
                                            <button class="journal__close" data-journal-close></button>
                                            <div class="journal__list">
                                                                                                    <a href="../wp-content/uploads/2019/09/%eb%8d%b0%ec%bd%94%ec%a0%80%eb%84%90-6%ec%9b%94%ed%98%b8-%eb%82%b4%ec%a7%80-%ed%99%95%ec%9d%b8%ec%9a%a9.pdf" target="_blank" class="item journal__item">
                                                        <div class="item__image " src="#" data-bg-size="cover" data-bg-pos="center"></div>
                                                        <div class="item__title">
                                                            Diamond Hill                                                        </div>
                                                    </a>
                                                                                                    <a href="../wp-content/uploads/2019/09/%eb%8d%b0%ec%bd%94%ec%a0%80%eb%84%90-10%ec%9b%94%ed%98%b8-%eb%82%b4%ec%a7%80-%ed%99%95%ec%9d%b8%ec%9a%a9-F.pdf" target="_blank" class="item journal__item">
                                                        <div class="item__image " src="#" data-bg-size="cover" data-bg-pos="center"></div>
                                                        <div class="item__title">
                                                            Catch Seafood Restaurant                                                        </div>
                                                    </a>
                                                                                            </div>
                                        </div>
                                    </div>
                                                                                                                                <a href="../wp-content/uploads/2019/09/AD-p.pdf" target="_blank" class="card media__card" data-media-card data-filter-card="magazines">
                                            <!--<button class="card__button" data-media-card-btn></button>-->
                                            <div class="card__wrap">
                                                <img class="card__image" src="../wp-content/uploads/2019/09/3.png">
                                            </div>
                                        </a>
                                                                                                                                <a href="../wp-content/uploads/2019/09/HOME_16-YS-1.pdf" target="_blank" class="card media__card" data-media-card data-filter-card="magazines">
                                            <!--<button class="card__button" data-media-card-btn></button>-->
                                            <div class="card__wrap">
                                                <img class="card__image" src="../wp-content/uploads/2019/09/4.png">
                                            </div>
                                        </a>
                                                                                                                                <a href="../wp-content/uploads/2019/09/style-68.pdf" target="_blank" class="card media__card" data-media-card data-filter-card="magazines">
                                            <!--<button class="card__button" data-media-card-btn></button>-->
                                            <div class="card__wrap">
                                                <img class="card__image" src="../wp-content/uploads/2019/09/5.png">
                                            </div>
                                        </a>
                                                                                                                            <div class="card media__card" data-media-card data-filter-card="magazines">
                                        <button class="card__button" data-media-card-btn></button>
                                        <div class="card__wrap">
                                            <img class=" card__image" src="../wp-content/uploads/2018/03/%d0%b0%d1%80%d1%85%d0%b8%d0%b4%d0%b5%d1%8f-1.html">
                                        </div>
                                        <div class="journal card__journal" data-journal>
                                            <button class="journal__close" data-journal-close></button>
                                            <div class="journal__list">
                                                                                                    <a href="http://ydzn-dev.de-v.pw/wp-content/uploads/2018/05/01_1.pdf" target="_blank" class="item journal__item">
                                                        <div class="item__image " src="#" data-bg-size="cover" data-bg-pos="center"></div>
                                                        <div class="item__title">
                                                            Interior Mebel-2014: СОЗИДАНИЕ                                                        </div>
                                                    </a>
                                                                                                    <a href="http://ydzn-dev.de-v.pw/wp-content/uploads/2018/05/2.pdf" target="_blank" class="item journal__item">
                                                        <div class="item__image " src="#" data-bg-size="cover" data-bg-pos="center"></div>
                                                        <div class="item__title">
                                                            Суть дела                                                        </div>
                                                    </a>
                                                                                                    <a href="http://ydzn-dev.de-v.pw/wp-content/uploads/2018/05/56-57Arhidea02_2013web-2.pdf" target="_blank" class="item journal__item">
                                                        <div class="item__image " src="#" data-bg-size="cover" data-bg-pos="center"></div>
                                                        <div class="item__title">
                                                            Выше крыш                                                        </div>
                                                    </a>
                                                                                                    <a href="http://ydzn-dev.de-v.pw/wp-content/uploads/2018/05/130-135Arhidea10_14web-2.pdf" target="_blank" class="item journal__item">
                                                        <div class="item__image " src="#" data-bg-size="cover" data-bg-pos="center"></div>
                                                        <div class="item__title">
                                                            Во саду ли...                                                        </div>
                                                    </a>
                                        ...
                                        <button class="card__button" data-media-card-btn></button>
                                        <div class="card__wrap">
                                            <img class=" card__image" src="../wp-content/uploads/2018/03/id-interior.png">
                                        </div>
                                        <div class="journal card__journal" data-journal>
                                            <button class="journal__close" data-journal-close></button>
                                            <div class="journal__list">
                                                                                                    <a href="http://ydzn-dev.de-v.pw/wp-content/uploads/2018/05/Dizaap.pdf" target="_blank" class="item journal__item">
                                                        <div class="item__image " src="#" data-bg-size="cover" data-bg-pos="center"></div>
                                                        <div class="item__title">
                                                            Открытие салона-офиса от Dizaap                                                        </div>
                                                    </a>
                                                                                                    <a href="http://ydzn-dev.de-v.pw/wp-content/uploads/2018/05/ID.-Interior-Design-3-4-April-2014.pdf" target="_blank" class="item journal__item">
                                                        <div class="item__image " src="#" data-bg-size="cover" data-bg-pos="center"></div>
                                                        <div class="item__title">
                                                            Интерьер с ароматом пряностей                                                        </div>
                                                    </a>
                                                                                                    <a href="http://ydzn-dev.de-v.pw/wp-content/uploads/2018/05/Private-Yodezeen-2017.pdf" target="_blank" class="item journal__item">
                                                        <div class="item__image " src="#" data-bg-size="cover" data-bg-pos="center"></div>
                                                        <div class="item__title">
                                                            Пронизанный медью                                                        </div>
                                                    </a>
                                                                                                    <a href="http://ydzn-dev.de-v.pw/wp-content/uploads/2018/05/Public_Yodezeen-2018.pdf" target="_blank" class="item journal__item">
                                                        <div class="item__image " src="#" data-bg-size="cover" data-bg-pos="center"></div>
                                                        <div class="item__title">
                                                            CATCH Большой улов                                                        </div>
                                                    </a>
                                                                                                    <a href="http://ydzn-dev.de-v.pw/wp-content/uploads/2018/05/Travel_ART-SPACE.pdf" target="_blank" class="item journal__item">
                                                        <div class="item__image " src="#" data-bg-size="cover" data-bg-pos="center"></div>
                                                        <div class="item__title">
                                                            ART SPACE в Лондоне                                                        </div>
                                                    </a>
                                                                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <button class="card__button" data-media-card-btn></button>
                                        <div class="card__wrap">
                                            <img class=" card__image" src="../wp-content/uploads/2018/03/%d0%b4%d0%be%d0%bc-%d0%b8-%d0%b8%d0%bd%d1%82%d0%b5%d1%80%d1%8c%d0%b5%d1%80.html">
                                        </div>
                                        <div class="journal card__journal" data-journal>
                                            <button class="journal__close" data-journal-close></button>
                                            <div class="journal__list">
                                                                                                    <a href="http://ydzn-dev.de-v.pw/wp-content/uploads/2018/05/April-2015.pdf" target="_blank" class="item journal__item">
                                                        <div class="item__image " src="#" data-bg-size="cover" data-bg-pos="center"></div>
                                                        <div class="item__title">
                                                            Lique Miami Restaurant & Lounge                                                        </div>
                                                    </a>
                                                                                                    <a href="http://ydzn-dev.de-v.pw/wp-content/uploads/2018/05/DiI2_Yodezeen_interv.pdf" target="_blank" class="item journal__item">
                                                        <div class="item__image " src="#" data-bg-size="cover" data-bg-pos="center"></div>
                                                        <div class="item__title">
                                                            Современный взгляд на классику                                                        </div>
                                                    </a>
                                                                                                    <a href="http://ydzn-dev.de-v.pw/wp-content/uploads/2018/05/DiI3_yodezeen.pdf" target="_blank" class="item journal__item">
                                                        <div class="item__image " src="#" data-bg-size="cover" data-bg-pos="center"></div>
                                                        <div class="item__title">
                                                            Сплетение стилей                                                        </div>
                                                    </a>
                                                                                                    <a href="http://ydzn-dev.de-v.pw/wp-content/uploads/2018/05/DiI4_Yodezeen-кактус.pdf" target="_blank" class="item journal__item">
                                                        <div class="item__image " src="#" data-bg-size="cover" data-bg-pos="center"></div>
                                                        <div class="item__title">
                                                            Посреди знойной пустыни                                                        </div>
                                                    </a>
                                                                                                    <a href="http://ydzn-dev.de-v.pw/wp-content/uploads/2018/05/DiI5_Yodezeen_Exuma2.pdf" target="_blank" class="item journal__item">
                                                        <div class="item__image " src="#" data-bg-size="cover" data-bg-pos="center"></div>
                                                        <div class="item__title">
                                                            Где всегда тепло                                                        </div>
                                                    </a>
                                                                                                    <a href="http://ydzn-dev.de-v.pw/wp-content/uploads/2018/05/DiI5_Yodezeen_Tolstyi_Tonkiy.pdf" target="_blank" class="item journal__item">
                                                        <div class="item__image " src="#" data-bg-size="cover" data-bg-pos="center"></div>
                                                        <div class="item__title">
                                                            Tolstiy & Tonkiy Время отдыха                                                        </div>
                                                    </a>
                                                                                                    <a href="http://ydzn-dev.de-v.pw/wp-content/uploads/2018/05/DiI7_Sharf_Zverev.pdf" target="_blank" class="item journal__item">
                                                        <div class="item__image " src="#" data-bg-size="cover" data-bg-pos="center"></div>
                                                        <div class="item__title">
                                                            Венецианские традиции                                                        </div>
                                                    </a>
                                                                                                    <a href="http://ydzn-dev.de-v.pw/wp-content/uploads/2018/05/January-2016.pdf" target="_blank" class="item journal__item">
                                                        <div class="item__image " src="#" data-bg-size="cover" data-bg-pos="center"></div>
                                                        <div class="item__title">
                                                            Английские Липки                                                        </div>
                                                    </a>
                                                                                                    <a href="http://ydzn-dev.de-v.pw/wp-content/uploads/2018/05/September-2016.pdf" target="_blank" class="item journal__item">
                                                        <div class="item__image " src="#" data-bg-size="cover" data-bg-pos="center"></div>
                                                        <div class="item__title">
                                                            Квартира для художницы                                                        </div>
                                                    </a>
                                                                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <button class="card__button" data-media-card-btn></button>
                                        <div class="card__wrap">
                                            <img class=" card__image" src="../wp-content/uploads/2018/03/%d0%ba%d1%83%d1%85%d0%bd%d0%b8.png">
                                        </div>
                                        <div class="journal card__journal" data-journal>
                                            <button class="journal__close" data-journal-close></button>
                                            <div class="journal__list">
                                                                                                    <a href="http://ydzn-dev.de-v.pw/wp-content/uploads/2018/05/Cactus-Loft-apartment.pdf" target="_blank" class="item journal__item">
                                                        <div class="item__image " src="#" data-bg-size="cover" data-bg-pos="center"></div>
                                                        <div class="item__title">
                                                            Кактусы и лофт                                                        </div>
                                                    </a>
                                                                                                    <a href="http://ydzn-dev.de-v.pw/wp-content/uploads/2018/05/YoDezeen_Semifreddo-restaurant.pdf" target="_blank" class="item journal__item">
                                                        <div class="item__image " src="#" data-bg-size="cover" data-bg-pos="center"></div>
                                                        <div class="item__title">
                                                            Уголок Италии в Киеве                                                        </div>
                                                    </a>
                                                                                            </div>
                                        </div>
                                    </div>
                                                                                                                                                            <a href="http://ydzn-dev.de-v.pw/wp-content/uploads/2018/05/LIQUE-Restaurant.pdf" target="_blank" class="card media__card" data-media-card data-filter-card="books">
                                            <!--<button class="card__button" data-media-card-btn></button>-->
                                            <div class="card__wrap">
                                                <img class="card__image" src="../wp-content/uploads/2018/03/book-2.png">
                                            </div>
                                        </a>
                                                                                                                                <a href="../wp-content/uploads/2019/09/Pa%cc%81ginas-desde00557_WOOD-IRON_001-336-2.pdf" target="_blank" class="card media__card" data-media-card data-filter-card="books">
                                            <!--<button class="card__button" data-media-card-btn></button>-->
                                            <div class="card__wrap">
                                                <img class="card__image" src="../wp-content/uploads/2019/09/1-3.png">
                                            </div>
                                        </a>
