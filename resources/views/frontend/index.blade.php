    ...
    <div class="wrapper">
        ...
        <div class="text about__text">
            <div class="text__column wow fadeInUp" data-wow-delay="1.3s">
                <p>
                    ASDS is a multi-award-winning architectural and design studio operating in the field of interior
                    ...
                    in Kyiv, Miami, and Los Angeles, ASDS has become the rising contemporary star in design and
                    architecture. </p>
            </div>
    ...
    <div class="wrapper career__wrapper">
        <div class="career__inner">
            ...
            <div class="text career__text wow fadeInUp" data-wow-delay="1.3s">
                <p>
                    ASDS is a great deal. It is a great deal for those who are mad in love with architectural and
            ...
            <div class="career__list">
                <div class="career__column" style="width:100%" >
                  
                   @foreach($careers as $career)
                       
               
                        <div class="card career__card wow fadeInUp" style="float:left;width:50%" data-wow-delay="1.6s">
            ...
            <div class="contact__list">
                <div class="contact__row">
                    <div class="card contact__card wow fadeInUp" data-wow-delay="0.5s">
                        ...
                        <a href="mailto:info@asds.com" class="card__info">
                            info@asds.com </a>
                    </div>
                    <div class="card contact__card wow fadeInUp" data-wow-delay="0.8s">
                        ...
                        <a href="mailto:pr@asds.com" class="card__info">
                            pr@asds.com </a>
                    </div>
                    <div class="card contact__card wow fadeInUp" data-wow-delay="1.1s">
                        ...
                        <a href="mailto:hr@asds.com" class="card__info">
                            hr@asds.com </a>
                    </div>
                </div>
                <div class="contact__row">
...
<section class="map">
    <div class="wrapper wrapper_full map__wrapper">
        ...
        <div class="map__cities">
            ...
            <button class="card card_right card_miami map__card btn_map" data-mark-country="PK-PB" data-modal-open="contact"
                data-city="PK-PB">
        ...
        <div class="footer__inner" style="height: auto; padding-bottom: 38px;">
            <div class="footer__copyright wow fadeInUp">
                ...
                <div
                    ...
                    materials on this Site belong to ASDS LLC. You may request permission to use them by
                    contacting us at: <a href="#">privacy@asds.com</a>
                </div>
